...
--
-- Host: localhost
-- Generation Time: Apr 13, 2023 at 06:27 AM
...
(13, 'drink', 8, 'itemnew'),
(14, 'entree', 2.99, 'krab'),
(15, 'entree', 8.99, 'lobster'),
(16, 'dessert', 7.66, 'itemnew3');
...
INSERT INTO `party` (`id`, `party_name`, `party_status`) VALUES
(1, 'party1', 'NOTSERVED'),
(2, 'party2', 'SERVED'),
(3, 'party3', 'NOTSERVED');
...
INSERT INTO `party_order` (`id`, `item_id`, `item_name`, `party_id`, `party_name`, `item_status`, `item_quantity`, `item_total`) VALUES
(1, 3, 'filet mignon', 2, 'party2', 'READY', 1, 20),
(2, 3, 'filet mignon', 1, 'party1', 'NOTREADY', 1, 20),
(3, 4, 'tacos', 1, 'party1', 'NOTREADY', 1, 12.59);
